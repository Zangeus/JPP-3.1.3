...
function showUserPage() {
    ...
    fetch(userActive)
        ...
        .then(data => {
            roleLet = '';
            data.roles.forEach((role) => roleLet += role.toString + " ");
            userInfoOutput = `
            <tr>
                <td>${data.id}</td>
                <td>${data.name}</td>
...
editModalForm.addEventListener('submit', (e) => {
    ...
    const nameById = document.getElementById('nameEdit');
    const surnameById = document.getElementById('surnameEdit');
...
createUserForm.addEventListener('submit', (e) => {
    ...
    const surnameById = document.getElementById('surname');
